...
export const projects = [
  {
    ...
    videos: [
      { category: 'Web', title: '메인보드', url: 'https://youtu.be/o3HNJbuCSKQ' },
      { category: 'Web', title: '회원가입/로그인', url: 'https://youtu.be/QvaJMhz81xY' },
      { category: 'Web', title: '챗봇 - 생성', url: 'https://youtu.be/atigjA0xQJY' },
      { category: 'Web', title: '챗봇 - 수정', url: 'https://youtu.be/z_NkxqvY-7k' },
      { category: 'Web', title: '챗봇 - 삭제', url: 'https://youtu.be/gfGbU0bUZU4' },
      { category: 'Web', title: '챗봇 - 지출패턴', url: 'https://youtu.be/gauifz9F-hQ' },
      { category: 'Web', title: '챗봇 - 최근 내역 수정/삭제', url: 'https://youtu.be/TaZm9pF5ZTk' },
      { category: 'Web', title: '챗봇 - 예외처리', url: 'https://youtu.be/CLu_0wWFd-w' },
      { category: 'Web', title: '대시보드', url: 'https://youtu.be/fSsPRxR43PY' },
      { category: 'Web', title: '지출 내역', url: 'https://youtu.be/ioZXk6E2WyE' },
      { category: 'App', title: '회원가입/로그인', url: 'https://youtu.be/Dw6jjZU03zE' },
      { category: 'App', title: '챗봇 - 생성', url: 'https://youtu.be/SCrkEMFDxHU' },
      { category: 'App', title: '챗봇 - 지출패턴', url: 'https://youtu.be/vQYWVydoJy8' },
      { category: 'App', title: '챗봇 - 수정', url: 'https://youtu.be/OuJ31b3nRKE' },
      { category: 'App', title: '챗봇 - 삭제', url: 'https://youtu.be/zgtfDeHOZ2U' },
      { category: 'App', title: '챗봇 - 예외처리', url: 'https://youtu.be/f-t-oYi9F78' },
      { category: 'App', title: '통계', url: 'https://youtu.be/M_pYp_wXjYY' },
      { category: 'App', title: '회원 정보 수정', url: 'https://youtu.be/BJyHPwWKPhM' },
    ],
  },

  {
    ...
    videos: [
      { category: 'Web', title: '회원가입/로그인', url: 'https://youtu.be/k0lZueE6x7I' },
      { category: 'Web', title: '루틴 기록', url: 'https://youtu.be/A8zvVjeONks' },
      { category: 'Web', title: '월간통계', url: 'https://youtu.be/Upwzu-HdF48' },
    ],
  },
